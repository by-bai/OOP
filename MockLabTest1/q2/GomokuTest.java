public class GomokuTest {
    ...
    public static void testDiagonalForwardSlash() {
        try {
            ...
            int count4 = game.count('X', 6, 1, Direction.DIAGONAL_FORWARD_SLASH);
            System.out.println("Expected:5");
            System.out.println("Actual  :" + count4);
            System.out.println();

            System.out.println("Test 2.2");
            int count3 = game.count('X', 5, 2, Direction.DIAGONAL_FORWARD_SLASH);
            System.out.println("Expected:4");
            System.out.println("Actual  :" + count3);
            System.out.println();

            System.out.println("Test 2.3");
            int count1 = game.count('X', 4, 3, Direction.DIAGONAL_FORWARD_SLASH);
            System.out.println("Expected:4");
            System.out.println("Actual  :" + count1);
            System.out.println();

            System.out.println("Test 2.4");
            int count2 = game.count('X', 3, 4, Direction.DIAGONAL_FORWARD_SLASH);
            System.out.println("Expected:4");
            System.out.println("Actual  :" + count2);
            System.out.println();
